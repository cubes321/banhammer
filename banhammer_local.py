...
#
# Note: The first time you run this script, it will download the AI model
# (microsoft/DialoGPT-small), which may take a few moments.
    ...
    def __init__(self):
        ...
        if pipeline is None:
            ...
            try:
                ...
                self.generator = hf_pipeline('text-generation', model='Qwen/Qwen3-4B')
    ...
    def generate_message(self, user, chat_history):
        ...
        try:
            ...
            outputs = self.generator(
                prompt,
                max_new_tokens=20,  # Limit the length of the generated response
